...
sfdx-devops/0.1.1 win32-x64 node-v10.16.0
$ sfdx --help [COMMAND]
USAGE
  $ sfdx COMMAND
...
...
_See code: [src\commands\devops\mdsource\compare\build.ts](https://github.com/aheber/sfdx-devops/blob/v0.1.1/src\commands\devops\mdsource\compare\build.ts)_
...
_See code: [src\commands\devops\workflow\emailalert\replaceaddress.ts](https://github.com/aheber/sfdx-devops/blob/v0.1.1/src\commands\devops\workflow\emailalert\replaceaddress.ts)_
<!-- commandsstop -->
